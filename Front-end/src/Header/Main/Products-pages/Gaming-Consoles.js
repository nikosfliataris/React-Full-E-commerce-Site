...
import "./Gaming-Consoles.css";
import Gamingproducts from "./info-pages/Gamingproducts";
...
function GamingProducts() {
  ...
  const getProducts = () => {
    db.collection("Gaming-Consoles").onSnapshot((snapshot) => {
      setProductsG(
  ...
  const handleAdd = (e) => {
    e.preventDefault();
    db.collection("Gaming-Consoles").doc(id).set({
      title: title,
      image: image,
      price: price,
      ...
      <div className="products">
        <div className="breadcrumb-column">
          <Breadcrumb className="breadcrumb">
            ...
            <Breadcrumb.Item active>Gaming Console's</Breadcrumb.Item>{" "}
          </Breadcrumb>
        </div>
        <div className="sidebar-container container">
          <Filterbar />
        </div>
        <div id="game-list-product ">
