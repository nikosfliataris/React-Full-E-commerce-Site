...
import "./SmartTv.css";
import Tvproducts from "./info-pages/Tvproducts";
...
function TvProducts() {
  ...
  const getProducts = () => {
    db.collection("Smart-Tv").onSnapshot((snapshot) => {
      setProductsTv(
  ...
  const handleAdd = (e) => {
    e.preventDefault();
    db.collection("Smart-Tv").doc(id).set({
      title: title,
      image: image,
      price: price,
      ...
      <div className="products">
        <div className="breadcrumb-column">
          <Breadcrumb className="breadcrumb">
            ...
            <Breadcrumb.Item active>Smart Tv</Breadcrumb.Item>
          </Breadcrumb>
        </div>
        <div className="sidebar-container container">
          <Filterbar />
        </div>
        <div id="tv-list-product">
          {productsTv.map((product) => (
            <Tvproducts
