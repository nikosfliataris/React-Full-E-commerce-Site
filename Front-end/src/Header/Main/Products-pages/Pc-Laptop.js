...
import "./Pc-Laptop.css";
import Pcproducts from "./info-pages/Pcproducts";
...
function PcProducts() {
  ...
  const getProducts = () => {
    db.collection("Pc and Laptop").onSnapshot((snapshot) => {
      setProductsPc(
  ...
  const handleAdd = (e) => {
    e.preventDefault();
    db.collection("Pc and Laptop").doc(id).set({
      title: title,
      image: image,
      price: price,
      ...
      <div className="products">
        <div className="breadcrumb-column">
          <Breadcrumb className="breadcrumb">
            ...
            <Breadcrumb.Item active>Pc and Laptop</Breadcrumb.Item>{" "}
          </Breadcrumb>
        </div>
        <div className="sidebar-container container">
          <Filterbar />
        </div>
        <div id="pc-list-product ">
          {productsPc.map((product) => (
            <Pcproducts
